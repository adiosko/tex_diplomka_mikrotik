...
\end{itemize}
Všetky implementácie v kóde boli použité vo verzovacom systéme github \cite{git} za použitia technológie git. Technológia git predstavuje verzovací systém na rôzne vetvy, hlavnú vetvu predstavuje master vetva, potom sú tu užívateľsky definované vetvy. \\
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.21]{../text/designer.png}
\caption{Rozhranie QT4 designer}
